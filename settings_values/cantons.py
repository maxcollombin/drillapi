CANTONS_LIST = [
    {
        ...
        "wmsUrl": "http://wms.zh.ch/AwelGSWaermewwwZHWMS",
    ...
    },
    {
        ...
        "wmsUrl": "services.geo.zg.ch:443/ows/Erdwaermenutzung",
        "infoFormat": "application/vnd.ogc.gml",
        "layers": [
            {
    ...
    },
    {
        ...
        "mapServerUrl": "https://sit.vs.ch/arcgis/services/ENVIRONNEMENT/MapServer/WMSServer",
        "wmsUrlEsriLayer": "3",
        "mapServerUrlLegendUrl": "",
        ...
        "layers": [
            {
                ...
                "propertyValues": [
                    ...
                    {"name": 5, "desc": "Hors zone (contacter le SEN)", "summand": 4},
                ],
            }
        ],
        "harmonyMap": [
    ...
    },
    {
        ...
        "mapServerUrlLegendUrl": "https://map.geo.tg.ch/services/geofy_chsdi3/static/images/legends/erdwaerme_eignung_de.png",
        "infoFormat": "application/vnd.ogc.gml",
        "layers": [
            {
                "name": "Eignungszonen",
    ...
    },
    {
        ...
        "mapServerUrlLegendUrl_": "https://public.geo.lu.ch/ogd/services/managed/EWNUTZXX_COL_V3_MP/MapServer/WMSServer?request=GetLegendGraphic%26version=1.3.0%26format=image/png%26layer=3",
        "mapServerUrlLegendUrl": "https://github.com/SFOE/SuitabilityGeothermalDrillingSwitzerland/raw/main/images/legend_lu.png",
        "infoFormat": "application/geo+json",
        "loopLayers": True,
        "layers": [
            {
    ...
    },
    {
        ...
        "wmsUrl2": "https://map.geo.fr.ch/arcgis/rest/services/PortailCarto/Theme_environnement/MapServer/identify",
        ...
        "layers": [
            {
                ...
                "propertyValues": [
                    ...
                    {"name": "SGV avec demande préalable obligatoire", "summand": 2},
    ...
    },
    {
        ...
        "exampleLocation": [
            ...
            [2623417, 1270092, 3, "undefined", "ausserhalb BL"],
            [2623503, 1259120, 2, "B"],
        ...
        "layers": [
            {
                ...
                "propertyValues": [
                    ...
                    {"name": "zulässig", "summand": 1},
                    {"name": "bedingt zulässig (siehe Erläuterungen)", "summand": 2},
                    {"name": "bedingt zulässig aufgrund: Hydrogeologie", "summand": 2},
                    {
